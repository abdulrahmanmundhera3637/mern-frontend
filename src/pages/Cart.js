            ...
            <div className='flex flex-col lg:flex-row gap-4 lg:gap-10 lg:justify-between'>
                ...
                <div className='w-full lg:max-w-3xl'>
                    {loading ? (
                        ...
                        data.map((product) => (
                            <div key={product._id} className='w-full bg-white h-32 my-2 border border-slate-300 rounded grid grid-cols-[128px,1fr] gap-2 lg:gap-4'>
                ...
                <div className='mt-5 lg:mt-0 w-full lg:max-w-sm'>
                    {loading ? (
                        ...
                        <div className='h-36 bg-white p-4 rounded'>
